...
public class MyPreference {
    ...
    public final String CHAT_ROOM_ID = "chatRoomId";
    ...
    public void setChatRoomId(String senderRoomId){
        sharedPreferences.edit().putString(CHAT_ROOM_ID,senderRoomId).apply();
    }
    public String getChatRoomId(){
        return sharedPreferences.getString(CHAT_ROOM_ID,"");
    }
