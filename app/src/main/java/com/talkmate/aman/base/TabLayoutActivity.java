package com.talkmate.aman.base;
...
import com.talkmate.aman.authentication.BiometricAuthActivity;
import com.talkmate.aman.authentication.PinLockActivity;
...
import com.talkmate.aman.home.HomeFragment;
import com.talkmate.aman.home.PasswordGeneratorActivity;
import com.talkmate.aman.home.addpassword.AddPasswordActivity;
import com.talkmate.aman.messages.AddContactEmailDialogFragment;
import com.talkmate.aman.messages.MessagesFragment;
import com.talkmate.aman.notes.NotesFragment;
import com.talkmate.aman.notes.addnote.AddNotesActivity;
import com.talkmate.aman.settings.SettingFragment;
...
public class TabLayoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabAddContactEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AddContactEmailDialogFragment dialogFragment = new AddContactEmailDialogFragment(TabLayoutActivity.this, senderPublicUid);
        ...
        Objects.requireNonNull(tabLayout.getTabAt(0)).setIcon(R.drawable.vault);
        Objects.requireNonNull(tabLayout.getTabAt(1)).setIcon(R.drawable.chats_new_set);
        Objects.requireNonNull(tabLayout.getTabAt(2)).setIcon(R.drawable.outline_group_24);
        Objects.requireNonNull(tabLayout.getTabAt(3)).setIcon(R.drawable.setting_new_set);

        Objects.requireNonNull(tabLayout.getTabAt(0)).setText("Vault");
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (position) {
                    case 0:
                        ...
                        tvTitle.setText("Vault");
                        Intent intent = new Intent(TabLayoutActivity.this, BiometricAuthActivity.class);
                        intent.putExtra(logInActivity.REQUEST_CODE_NAME, "MessagesFragment");
                        startActivity(intent);
                        break;
                    case 1:
                        selectedTab = 2;
    ...
    protected void onStart() {
        super.onStart();
//        //to check if is opened in stack or not
